...
- `generate_release_notes`: `true` to generate release notes for the release. `false` to not generate release notes. Default: `false`
#### `body_path`
...
## Contributing
We would love you to contribute to `@comnoco/create-release`, pull requests are welcome! Please see the [CONTRIBUTING.md](CONTRIBUTING.md) for more information.
